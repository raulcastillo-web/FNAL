...
class NightSelectScene extends Phaser.Scene {
    ...
    create() {
        ...
        // Noches disponibles
        const nights = [
            { num: 1, name: 'Números Enteros', difficulty: 'FÁCIL', color: 0xff4444 },
            { num: 2, name: 'Fracciones y Decimales', difficulty: 'FÁCIL-MODERADO', color: 0xff9944 },
            { num: 3, name: 'Porcentajes y Ratios', difficulty: 'MODERADO', color: 0xffdd44 },
            { num: 4, name: 'Álgebra Básica', difficulty: 'MODERADO-DIFÍCIL', color: 0x44ddff },
            { num: 5, name: 'Geometría y Exponentes', difficulty: 'DIFÍCIL', color: 0xff44ff }
        ];
